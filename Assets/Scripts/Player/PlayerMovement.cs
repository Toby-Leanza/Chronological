...
public class PlayerMovement : MonoBehaviour
{
    ...
    public void OnJump(InputAction.CallbackContext context)
    {
        ...
        {
            jumpPressed = true;
            // No hay sonido de salto, solo el de ca�da despu�s
        }
    }
    ...
    {
        // Reproducir sonido de ca�da al aterrizar
        if (isGrounded && !wasGrounded)
        {
            // Peque�o delay para que no se reproduzca en el salto inicial
            if (rb.linearVelocity.y < -2f) // Solo si cay� desde cierta altura
            {
